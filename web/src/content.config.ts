...
// para un lector externo. Los ADR no alimentan esta colección: se
// sintetiza, no se reutiliza documentación interna cruda. Orden, título, descripción y agrupación salen del
