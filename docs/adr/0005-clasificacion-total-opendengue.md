...
* Negativo: si la base de datos ya tiene datos cargados al momento de aplicar esta migración, hace falta `docker compose down -v` y reingesta completa — el proyecto sigue sin un runner de migraciones (no resuelto por este ADR).
