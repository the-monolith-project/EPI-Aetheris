...
- **Entrenamiento:** 197 filas, años 2018, 2021, 2022, 2023.
...
- **Distribución real del año de prueba (2019):** {'alto': 41, 'medio': 9}.

**Hallazgo a declarar sin maquillar:** el año de prueba 2019 tiene 41 semanas reales etiquetadas "alto" con el corte P50/P75 -- el recall de "alto" del modelo fue **0.000** (la línea base climatológica obtuvo el mismo resultado). El modelo no acertó ni una sola de esas semanas reales de alto riesgo -- con los predictores y el corte actuales, el clima rezagado solo no está capturando la señal de brote severo en este año de prueba. No es un hallazgo menor: contradice directamente la promesa de anticipación del proyecto y debe citarse así en el informe, no suavizarse.

## Modelo — métricas por clase

F1 macro: **0.000** · Recall 'alto': **0.000**

| Clase | Precisión | Recall | F1 | Soporte |
|---|---|---|---|---|
| bajo | 0.000 | 0.000 | 0.000 | 0 |
| medio | 0.000 | 0.000 | 0.000 | 9 |
| alto | 0.000 | 0.000 | 0.000 | 41 |
...
F1 macro: 0.576 · Recall 'alto': 0.950 (1 filas excluidas por no tener semana anterior contigua)

| Clase | Precisión | Recall | F1 | Soporte |
|---|---|---|---|---|
| bajo | 0.000 | 0.000 | 0.000 | 0 |
| medio | 0.778 | 0.778 | 0.778 | 9 |
| alto | 0.950 | 0.950 | 0.950 | 40 |
...
climatológica en F1 macro **y** en recall de "alto", por año de prueba — con 41 semanas reales de "alto" en 2019, el criterio sí es evaluable esta pasada: recall de "alto" del modelo = 0.000, de la línea base climatológica = 0.000.

## Importancia de variables (top 10, Random Forest)

| Variable | Importancia |
|---|---|
| punto_rocio_media_movil4 | 0.0647 |
| temp_min_media_movil4 | 0.0591 |
| precipitation_sum_lag1 | 0.0569 |
| temp_max_media_movil4 | 0.0557 |
| precipitation_hours_lag1 | 0.0555 |
| precipitation_hours_media_movil4 | 0.0523 |
| punto_rocio_lag2 | 0.0522 |
| punto_rocio_lag1 | 0.0503 |
| humedad_relativa_media_lag1 | 0.0501 |
| precipitation_sum_media_movil4 | 0.0495 |
