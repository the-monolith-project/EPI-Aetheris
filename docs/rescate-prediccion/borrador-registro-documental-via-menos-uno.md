...
- `docs/rescate-prediccion/respuesta-protocolo-via-menos-uno-v2.md`, especialmente las secciones 2–5, 7, 9 y 10.5;
- `docs/rescate-prediccion/protocolo-evaluacion-rescate-prediccion.md`, especialmente las secciones 15–17;
- `docs/rescate-prediccion/corrida-via-menos-uno.md`, que contiene la validación reproducible;
...
| Cerrar la puerta documental | `docs/rescate-prediccion/protocolo-evaluacion-rescate-prediccion.md` | Actualizar únicamente después de completar los dos registros anteriores |
...
- [ ] `docs/rescate-prediccion/respuesta-protocolo-via-menos-uno-v2.md` permaneció sin cambios sustantivos después de la firma.
