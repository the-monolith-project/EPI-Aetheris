...
**Hallazgo a declarar sin maquillar:** el año de prueba 2014 tiene 32 semanas reales etiquetadas "alto" con el corte P75/P90 -- el recall de "alto" del modelo fue **0.031** (la línea base climatológica obtuvo el mismo resultado). Revisar la matriz de confusión de abajo para ver en qué se equivocó exactamente.

## Modelo — métricas por clase

F1 macro: **0.047** · Recall 'alto': **0.031**

| Clase | Precisión | Recall | F1 | Soporte |
|---|---|---|---|---|
| bajo | 0.043 | 1.000 | 0.082 | 2 |
| medio | 0.000 | 0.000 | 0.000 | 14 |
| alto | 1.000 | 0.031 | 0.061 | 32 |
...
climatológica en F1 macro **y** en recall de "alto", por año de prueba — con 32 semanas reales de "alto" en 2014, el criterio sí es evaluable esta pasada: recall de "alto" del modelo = 0.031, de la línea base climatológica = 0.000.

## Importancia de variables (top 10, Random Forest)

| Variable | Importancia |
|---|---|
| punto_rocio_media_movil4 | 0.0653 |
| temp_min_media_movil4 | 0.0652 |
| temp_max_media_movil4 | 0.0626 |
| temp_media_media_movil4 | 0.0625 |
| humedad_relativa_media_media_movil4 | 0.0480 |
| precipitation_sum_lag2 | 0.0480 |
| temp_max_lag2 | 0.0480 |
| temp_min_lag1 | 0.0476 |
| punto_rocio_lag1 | 0.0474 |
| temp_min_lag2 | 0.0463 |
