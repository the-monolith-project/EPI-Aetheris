...
|---|---|
| temp_max_media_movil4 | 0.0736 |
| punto_rocio_media_movil4 | 0.0711 |
| precipitation_hours_lag1 | 0.0567 |
| temp_media_media_movil4 | 0.0543 |
| temp_media_lag1 | 0.0534 |
| temp_max_lag2 | 0.0509 |
| punto_rocio_lag1 | 0.0505 |
| humedad_relativa_media_lag1 | 0.0498 |
| punto_rocio_lag2 | 0.0497 |
| temp_media_lag2 | 0.0493 |
