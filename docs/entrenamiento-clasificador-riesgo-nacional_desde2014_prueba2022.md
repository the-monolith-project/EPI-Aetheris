...
F1 macro: **0.244** · Recall 'alto': **0.000**

| Clase | Precisión | Recall | F1 | Soporte |
|---|---|---|---|---|
| bajo | 0.638 | 0.857 | 0.732 | 35 |
...
|---|---|
| temp_media_media_movil4 | 0.0731 |
| temp_min_media_movil4 | 0.0671 |
| punto_rocio_media_movil4 | 0.0616 |
| temp_min_lag2 | 0.0581 |
| precipitation_hours_media_movil4 | 0.0516 |
| humedad_relativa_media_media_movil4 | 0.0513 |
| temp_min_lag1 | 0.0511 |
| temp_max_media_movil4 | 0.0502 |
| temp_media_lag1 | 0.0498 |
| temp_media_lag2 | 0.0464 |
